...
from SaberUB.helpers.pyrohelper import get_arg
import SaberUB.database.afkdb as Zect
from SaberUB.helpers.pyrohelper import user_afk
from SaberUB.modules.alive import get_readable_time
from SaberUB.helpers.utils import get_message_type, Types
...
async def afk(client, message):
    ...
    if not arg:
        ...
        reason = arg
    await SaberUB.set_afk(True, afk_time, reason)
