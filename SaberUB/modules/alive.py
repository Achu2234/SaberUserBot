...
from SaberUB import app, StartTime, CMD_HELP
...
async def alive(_, m):
    ...
    reply_msg = f"**[Saber](https://github.com/Achu2234/SaberUserBot)**\n"
    reply_msg += f"__Python__: `{__python_version__}`\n"
    reply_msg += f"__@Pyrogram version__: `{__pyro_version__}`\n"
    end_time = time.time()
    reply_msg += f"__Saber uptime__: {uptime}"
    photo = "https://telegra.ph/file/1170c355ab28bee6a654f.jpg"
    await m.delete()
